...
3. Commit message with resolved issues:

   ```
   docs: update readme with additional troubleshooting steps for arm64 architecture
...
4. Commit message with filename in body:
